        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4 mb-md-0">
                    <a class="category-item" href="{{ route('shop.index', $category->slug) }}">
                        @if($category->cover)
                            <img class="img-fluid"
                                 src="{{ asset('storage/images/categories/' . $category->cover) }}"
                                 alt="{{ $category->name }}">
                        @else
                            <img class="img-fluid" src="{{ $category->cover }}" alt="">
                        @endif
            ...
            <!-- <div class="row">
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <a class="category-item" href="{{ route('shop.index', $categories[3]->slug ?? '') }}">
                        ...
                        @endif
                        <strong class="category-item-title" style="margin-top: 104px;">{{ $categories[3]->name ?? '' }}</strong>
                    </a>
                </div>
...
<!-- banner area start -->
<div class="fruits-choose-area pb-65 bg-img mt-5" style="background-color:#86ab48; ">
    <div class="container">
        <div class="row">
