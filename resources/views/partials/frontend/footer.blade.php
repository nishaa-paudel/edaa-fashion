                            ...
                            <div class="food-about-info">
                                <div class="food-info-wrapper">
                                    ...
                                    <div class="food-address">
                                        ...
                                        <div class="food-info-content">
                                            <p>
                                                <a href="#">nishapoudel@gmail.com</a> <br>
                                                <a href="#" target="_blank">contact@gmail.com</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="footer-middle black-bg-2 pt-35 pb-40">
        <div class="container">
            ...
            <div class="text-center">
                <img width="120" height="60" src="{{ asset('frontend/img/icon-img/3.png') }}" alt="">
            </div>
        </div>
    </div>
    <div class="food-copyright black-bg-6 ptb-30">
        <div class="container text-center">
            <p class="copyright text-center">
                ...
                Created by
                <a href="#" target="_blank" class="text-primary">Nisha Podel</a>
            </p>
        </div>
    </div>
</footer>
