    ...
    <form wire:submit.prevent="{{ $editMode ? 'updateAddress' : 'storeAddress' }}" x-show="formShow" @click.away="formShow = false">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 form-group">
                ...
                <input class="form-control form-control-lg" wire:model="email" type="email" placeholder="e.g. shri@gmail.com">
                @error('email')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="phone">Phone number</label>
                <input class="form-control form-control-lg" wire:model="phone" type="tel" placeholder="e.g. +977 9800011111">
            ...
            <div class="col-lg-6 form-group">
                ...
                <input class="form-control form-control-lg" wire:model="address2" type="text" placeholder="Enter your address 2.">
            ...
            <div class="col-lg-6 form-group">
                ...
                <input class="form-control form-control-lg" wire:model="zip_code" type="text" placeholder="Enter your zip code">
                @error('zip_code')<span class="text-danger">{{ $message }}</span>@enderror
            </div>
            <div class="col-lg-6 form-group">
                <label class="text-small text-uppercase" for="po_box">P.O.Box</label>
                <input class="form-control form-control-lg" wire:model="po_box" type="text" placeholder="Enter your Post Box no. ">
